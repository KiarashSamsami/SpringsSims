function E = spring_costfunc_att22p(x,k1,r0,l1,k2,l2)
...
E_forces_from_next = 1/2*k2*(xnext_diff_mag-l2).^2 ; 
E_forces_from_prev = 1/2*k2*(xprev_diff_mag-l2).^2 ; 
...
E_e = sum(1/2*k1*(vecnorm(x-r0)-l1).^2) ;
E = E + E_e ; 