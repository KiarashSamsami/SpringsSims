function [dedx] = spring_costfunc_grad(r,x,l1,l2,k1,k2,grad_coef)
...
for i=1:size(x,2)
    ...
    dedx_1_neg = spring_costfunc(x,k1,r,l1,k2,l2);
    
    x = x0 ; 
    x(1,i) = x(1,i)+ grad_coef*max_delta_l ; 
    dedx_1_pos = spring_costfunc(x,k1,r,l1,k2,l2);
    dedx_1(i) = (dedx_1_pos - dedx_1_neg)/ (2*grad_coef*max_delta_l) ; 
    
    x = x0 ; 
    x(2,i) = x(2,i)- grad_coef*max_delta_l ; 
    dedx_2_neg = spring_costfunc(x,k1,r,l1,k2,l2);
    
    x = x0 ; 
    x(2,i) = x(2,i)+ grad_coef*max_delta_l ; 
    dedx_2_pos = spring_costfunc(x,k1,r,l1,k2,l2);
